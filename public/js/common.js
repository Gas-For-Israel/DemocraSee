...
$(function(){
    ...
    if (!$.cookie('welcome_popup')) {
        popupProvider.showOkPopup({
            message: '<div class="welcome-wrapper"><div class="welcome-title"><b>הזמנה להשתתפות בעריכת נייר עמדה בנושא מתווה הגז</b></div>\
<br ><br ><div class="welcome-text">\
             מערכת זו מאפשרת לכם להשתתף באופן פעיל בעריכת מסמך שיהווה בסיס לנייר עמדה שיוגש לממשלת ישראל במסגרת השימוע הציבורי סביב מתווה הגז, ולנהל סביבו דיון מתכנס. איך משתתפים בעריכת המסמך? פשוט מאוד: לחצו על הקטעים הממורקרים כדי להצביע בעד או נגד הצעות עריכה שהעלו משתמשים אחרים, ואם ברצונכם לפרסם הצעת עריכה משלכם - פשוט סמנו עם העכבר את הטקסט שברצונכם לשנות, ופרסמו הצעה לשינויליצור יחד כללי התנהגות מוסכמים במרחב הציבורי.\
<br><br>\
